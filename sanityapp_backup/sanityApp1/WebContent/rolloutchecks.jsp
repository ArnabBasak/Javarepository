  ...
  <!-- start content -->
    <div class="site-wrapper active" id="target">
      ...
      <div class="row">
        ...
        <div class="controls">
		<a href="#" title = "Check the D2.4.42 version for all UK stores"><i class="fa fa-paper-plane" onclick="div_show()"></i></a>
        </div>
        </div>
        </div>
        </div>
        ...
        <div class="controls">
		<a href="#" title = "Check the D2.4.43 version for all UK stores"><i class="fa fa-paper-plane" onclick="div_show()"></i></a>
        </div>
            </div>
          </div>
        </div>
        ...
        <div class="controls">
		<a href="#" title = "Check the D2.4.44 version for all UK stores"><i class="fa fa-paper-plane" onclick="div_show()"></i></a>
        </div>
            </div>
          </div>
        </div>
        ...
        <div class="controls">
		<a href="#" title = "Check the D2.4.45 version for all UK stores"><i class="fa fa-paper-plane" onclick="div_show()"></i></a>
        </div>
            </div>
          </div>
        </div>
        ...
        <div class="controls">
		<a href="#" title = "Check the D2.4.46 version for all UK stores"><i class="fa fa-paper-plane" onclick="div_show()"></i></a>
        </div>
            </div>
          </div>
        </div>
        ...
        <div class="controls">
		<a href="#" title = "Check the D2.4.47 version for all UK stores"><i class="fa fa-paper-plane" onclick="div_show()"></i></a>
        </div>
            </div>
          </div>
        </div>
        ...
        <div class="controls">
		<a href="#" title = "Check the D2.4.48 version for all UK stores"><i class="fa fa-paper-plane" onclick="div_show()"></i></a>
        </div>
            </div>
          </div>
        </div>
