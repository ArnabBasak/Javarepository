...
<script type="text/javascript" src="https://www.google.com/jsapi"></script>
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        ['Successful Replication', 14], //#008000
...
//pilot 1 date
PreparedStatement pilot1 = connection.prepareStatement("select pilot_Date from pilot where version = 'D2.4.48' and pilot_type = 'pilot 1'limit 1;");
...
//pilot 2 date
PreparedStatement pilot2 = connection.prepareStatement("select pilot_Date from pilot where version = 'D2.4.48' and pilot_type = 'pilot 2'limit 1;");
...
//pilot 3 date
PreparedStatement pilot3 = connection.prepareStatement("select pilot_Date from pilot where version = 'D2.4.48' and pilot_type = 'pilot 3'limit 1;");
...
//total pilot stores
PreparedStatement totalpilotstores = connection.prepareStatement("select count(*) from pilot where version = 'D2.4.48'");
...
//pilot 1 stores
PreparedStatement totalpilot1stores = connection.prepareStatement("select count(*) from pilot where pilot_type = 'pilot 1' and version = 'D2.4.48'");
...
PreparedStatement totalpilot2stores = connection.prepareStatement("select count(*) from pilot where pilot_type = 'pilot 2' and version = 'D2.4.48'");
...
PreparedStatement totalpilot3stores = connection.prepareStatement("select count(*) from pilot where pilot_type = 'pilot 3' and version = 'D2.4.48'");
...
//total failed stores
PreparedStatement totalfailedstores = connection.prepareStatement("select count(*) from pilot where dep_duration = 0 and version = 'D2.4.48'");
...
PreparedStatement totalsuccessfulstores = connection.prepareStatement("select count(*) from pilot where dep_duration != 0 and version = 'D2.4.48'");
...
//total successfuleod
PreparedStatement successeod = connection.prepareStatement("select count(*) From pilot where eod_duration != 0 and version = 'D2.4.48'");
...
PreparedStatement successfulrep = connection.prepareStatement("select count(*) From pilot where replication_duration != 0 and version = 'D2.4.48'");
...
PreparedStatement failrep = connection.prepareStatement("select count(*) From pilot where replication_duration = 0 and version = 'D2.4.48'");
...
//total failed eod
PreparedStatement faileod = connection.prepareStatement("select count(*) From pilot where eod_duration = 0  and version = 'D2.4.48'");
...
PreparedStatement pilot1fail = connection.prepareStatement("select count(*) from pilot where dep_duration = 0 and version = 'D2.4.48' and pilot_type = 'pilot 1'");
...
PreparedStatement pilot1success = connection.prepareStatement("select count(*) from pilot where dep_duration != 0 and version = 'D2.4.48' and pilot_type = 'pilot 1'");
...
//max pilot 1 max eod
PreparedStatement pilot1maxeod = connection.prepareStatement("select name,eod_duration from pilot where version = 'D2.4.48' and pilot_type = 'pilot 1' and eod_duration in(select max(eod_duration) from pilot where version = 'D2.4.48' and pilot_type = 'pilot 1')");
...
//min pilot 1 min eod
PreparedStatement pilot1mineod = connection.prepareStatement("select name,eod_duration from pilot where version = 'D2.4.48' and pilot_type = 'pilot 1' and eod_duration in(select min(eod_duration) from pilot where version = 'D2.4.48' and pilot_type = 'pilot 1' and eod_duration!=0)");
...
PreparedStatement pilot1maxrep = connection.prepareStatement("select name,replication_duration from pilot where version = 'D2.4.48' and pilot_type = 'pilot 1' and replication_duration in(select max(replication_duration) from pilot where version = 'D2.4.48' and pilot_type = 'pilot 1')");
...
PreparedStatement pilot1minrep = connection.prepareStatement("select name,replication_duration from pilot where version = 'D2.4.48' and pilot_type = 'pilot 1' and replication_duration in(select min(replication_duration) from pilot where version = 'D2.4.48' and pilot_type = 'pilot 1' and replication_duration!=0)");
...
PreparedStatement pilot1maxdep = connection.prepareStatement("select name,dep_duration from pilot where version = 'D2.4.48' and pilot_type = 'pilot 1' and dep_duration in(select max(dep_duration) from pilot where version = 'D2.4.48' and pilot_type = 'pilot 1')");
...
PreparedStatement pilot1mindep = connection.prepareStatement("select name,dep_duration from pilot where version = 'D2.4.48' and pilot_type = 'pilot 1' and dep_duration IN(select min(dep_duration) from pilot where version = 'D2.4.48' and pilot_type = 'pilot 1' and dep_duration!=0);");
...
PreparedStatement pilot2fail = connection.prepareStatement("select count(*) from pilot where dep_duration = 0 and version = 'D2.4.48' and pilot_type = 'pilot 2'");
...
PreparedStatement pilot2success = connection.prepareStatement("select count(*) from pilot where dep_duration != 0 and version = 'D2.4.48' and pilot_type = 'pilot 2'");
...
//pilot 2 max eod
PreparedStatement pilot2maxeod = connection.prepareStatement("select name,eod_duration from pilot where version = 'D2.4.48' and pilot_type = 'pilot 2' and eod_duration in(select max(eod_duration) from pilot where version = 'D2.4.48' and pilot_type = 'pilot 2')");
...
//pilot 2 min eod
PreparedStatement pilot2mineod = connection.prepareStatement("select name,eod_duration from pilot where version = 'D2.4.48' and pilot_type = 'pilot 2' and eod_duration in(select min(eod_duration) from pilot where version = 'D2.4.48' and pilot_type = 'pilot 2' and eod_duration!=0)");
...
PreparedStatement pilot2maxrep = connection.prepareStatement("select name,replication_duration from pilot where version = 'D2.4.48' and pilot_type = 'pilot 2' and replication_duration in(select max(replication_duration) from pilot where version = 'D2.4.48' and pilot_type = 'pilot 2')");
...
PreparedStatement pilot2minrep = connection.prepareStatement("select name,replication_duration from pilot where version = 'D2.4.48' and pilot_type = 'pilot 2' and replication_duration in(select min(replication_duration) from pilot where version = 'D2.4.48' and pilot_type = 'pilot 2' and replication_duration!=0)");
...
PreparedStatement pilot2maxdep = connection.prepareStatement("select name,dep_duration from pilot where version = 'D2.4.48' and pilot_type = 'pilot 2' and dep_duration IN(select max(dep_duration) from pilot where version = 'D2.4.48' and pilot_type = 'pilot 2');");
...
PreparedStatement pilot2mindep = connection.prepareStatement("select name,dep_duration from pilot where version = 'D2.4.48' and pilot_type = 'pilot 2' and dep_duration IN(select min(dep_duration) from pilot where version = 'D2.4.48' and pilot_type = 'pilot 2' and dep_duration!=0);");
...
PreparedStatement pilot3fail = connection.prepareStatement("select count(*) from pilot where dep_duration = 0 and version = 'D2.4.48' and pilot_type = 'pilot 3'");
...
PreparedStatement pilot3success = connection.prepareStatement("select count(*) from pilot where dep_duration != 0 and version = 'D2.4.48' and pilot_type = 'pilot 3'");
...
//pilot 3 max eod
PreparedStatement pilot3maxeod = connection.prepareStatement("select name,eod_duration from pilot where version = 'D2.4.48' and pilot_type = 'pilot 3' and eod_duration in(select max(eod_duration) from pilot where version = 'D2.4.48' and pilot_type = 'pilot 3')");
...
//pilot 3 min eod
PreparedStatement pilot3mineod = connection.prepareStatement("select name,eod_duration from pilot where version = 'D2.4.48' and pilot_type = 'pilot 3' and eod_duration in(select min(eod_duration) from pilot where version = 'D2.4.48' and pilot_type = 'pilot 3')");
...
PreparedStatement pilot3maxrep = connection.prepareStatement("select name,replication_duration from pilot where version = 'D2.4.48' and pilot_type = 'pilot 3' and replication_duration IN(select max(replication_duration) from pilot where version = 'D2.4.48' and pilot_type = 'pilot 3' );");
...
//min pilot 1 replication
PreparedStatement pilot3minrep = connection.prepareStatement("select name,replication_duration from pilot where version = 'D2.4.48' and pilot_type = 'pilot 3' and replication_duration in(select min(replication_duration) from pilot where version = 'D2.4.48' and pilot_type = 'pilot 3' and replication_duration!=0)");
...
PreparedStatement pilot3maxdep = connection.prepareStatement("select name,dep_duration from pilot where version = 'D2.4.48' and pilot_type = 'pilot 3' and dep_duration in(select max(dep_duration) from pilot where version = 'D2.4.48' and pilot_type = 'pilot 3')");
...
PreparedStatement pilot3mindep = connection.prepareStatement("select name,dep_duration from pilot where version = 'D2.4.48' and pilot_type = 'pilot 3' and dep_duration in(select min(dep_duration) from pilot where version = 'D2.4.48' and pilot_type = 'pilot 3' and dep_duration!=0)");
    ...
    <div class="site-wrapper active" id="target">
      <div class="site-wrapper_left-col">
        ...
        <div class="left-nav">
          ...
          <a href="foureightpilotanalytics.jsp" class="active"><i class="fa fa-pie-chart"></i>48 Pilot</a>
      ...
      <div class="row">
          ...
          <div class="user-item">
            <div class="user-item_info">
             <p class="name"><h3>D2.4.48 Pilot information</h3><br><p class="name">Pilot 1 Date&nbsp;&nbsp;<%out.println(pilot1date);%></p><br>
